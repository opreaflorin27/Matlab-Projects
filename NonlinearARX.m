...
% Plotting MSE for every possible m

i1=1:no_m; i2=no_m+1:2*no_m; i3=2*no_m+1:3*no_m;
figure
plot(i1,MSE_check(1:no_m,5));title("MSE for m=1");xlabel('Index');ylabel('MSE');grid;
figure
plot(i2,MSE_check(no_m+1:2*no_m,5));title("MSE for m=2");xlabel('Index');ylabel('MSE');grid;
figure
plot(i3,MSE_check(2*no_m+1:3*no_m,5));title("MSE for m=3");xlabel('Index');ylabel('MSE');grid;
%% ----------------------------------------------CLEANING--------------------------------------------------------
